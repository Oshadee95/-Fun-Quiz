...
public class ResultNavigationGUI extends NavigationPanel {
	...
	public ResultNavigationGUI() {
		...
		panel.setBounds(0, 335, UI.NAVIGATION_PANEL_WIDTH, UI.NAVIGATION_PANEL_BUTTON_HEIGHT);
		...
		panel.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				 ...
				 */
				PlayerGUI.selectedNavigation = new ResultNavigationGUI();
				PlayerGUI.selectedContent = new ResultContentGUI();
				PlayerGUI.setSelectedPanel();
			}
		});

		// Adding navigation button(JPanel) text to panel
		JLabel navigationLabel = new JLabel("RESULTS");
		...
		navigationIcon.setIcon(new ImageIcon(PlayerGUI.class.getResource("/com/funquiz/resources/results_icon.png")));
