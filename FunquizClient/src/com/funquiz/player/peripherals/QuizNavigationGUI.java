...
public class QuizNavigationGUI extends NavigationPanel {
	...
	public QuizNavigationGUI() {
		...
		panel.setBounds(0, 265, UI.NAVIGATION_PANEL_WIDTH, UI.NAVIGATION_PANEL_BUTTON_HEIGHT);
		...
		JLabel navigationLabel = new JLabel("QUIZ");
		...
		navigationIcon.setIcon(new ImageIcon(PlayerGUI.class.getResource("/com/funquiz/resources/questions_icon.png")));
