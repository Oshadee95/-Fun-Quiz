...
public class PlayerGUI extends JFrame {
	...
	private NavigationPanel resultNavigationPanel = new ResultNavigationGUI();
...
//		setIconImage(new ImageIcon(getClass().getResource("/resources/logo-2.png")).getImage());
		...
		leftSidePanel.setBounds(0, 0, 255, 661);
		...
		navigationPanelList.add(resultNavigationPanel);
		...
		leftSidePanel.add(resultNavigationPanel.getNavigation());
		...
		// application startup
		PlayerGUI.selectedNavigation = new QuizNavigationGUI();
	...
	private static void setSelectedNavigationPanel() {
		...
		for (NavigationPanel NavigationPanel : navigationPanelList) {
			...
			if (NavigationPanel.getNavigation().getName().toString()
					.equalsIgnoreCase(PlayerGUI.selectedNavigation.getNavigation().getName().toString())) {
	...
	private static void setSelectedContentPanel() {
		...
		rightSidePanel.add(PlayerGUI.selectedContent.getContent());
