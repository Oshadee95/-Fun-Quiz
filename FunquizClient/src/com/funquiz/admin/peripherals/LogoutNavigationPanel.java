	...
	public LogoutNavigationPanel() {
		...
		panel.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				 ...
				 */
				AdminGUI.selectedNavigation = new LogoutNavigationPanel();
				...
				FunquizClient.adminGUI.dispose();
			}
		});
		...
		navigationIcon.setIcon(new ImageIcon(AdminGUI.class.getResource("/com/funquiz/resources/logout_icon.png")));
